  ...
  describe "#each" do
    it "yields each registry key and settings" do
      ...
      expect(pairs).to contain_exactly(
        [:actions, Stroma::Settings::RegistrySettings],
        [:inputs, Stroma::Settings::RegistrySettings]
      )
    end
  end
