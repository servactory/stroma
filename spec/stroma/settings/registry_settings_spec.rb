  ...
  describe "#each" do
    it "yields each extension name and setting" do
      ...
      expect(pairs).to contain_exactly(
        [:authorization, Stroma::Settings::Setting],
        [:transactional, Stroma::Settings::Setting]
      )
    end
  end
